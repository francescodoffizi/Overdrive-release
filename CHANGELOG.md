...
- **Supporto Nativo BYD DiLink 5.0 (Snapdragon SA8155P / Sealion 7) in OverDrive**:
  ...
  - **Pipeline EGL & Dashcam Sicura (`EGLCore.java`, `OemDashcamPipeline.java`, `PanoramicCameraGpu.java`)**: Aggiunto fallback automatico GLES2 per contesti headless EGL e gestione sicura dell'assenza di `AVMCamera`.
